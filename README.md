# Magyar Posta Tracking API For Ruby
Magyar Posta Tracking API and webhook make it easy to integrate Magyar Posta Tracking function into your own project. Support APIs Client Libraries for ruby

### API key

In order to use this API, you need to generate a Magyar Posta Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use Magyar Posta Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Magyar Posta Tracking API](https://www.trackingmore.com/magyar-posta-tracking.html)  to:

   *   Get Magyar Posta realtime tracking info of muti-carriers in one integration
   *   Provide Magyar Posta shipment tracking experience like Amazon
   *   Push Magyar Posta notifications of package update with webhook
   *   Verify Magyar Posta delivery exception before it is too late
